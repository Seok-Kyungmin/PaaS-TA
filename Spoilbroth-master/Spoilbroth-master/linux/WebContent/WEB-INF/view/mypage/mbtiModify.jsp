...
<link
	...
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@700&family=Poppins:wght@400;500;700;800;900&display=swap"
	rel="stylesheet">
<link rel="stylesheet"
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile"
								style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 500;">
									...
									<div class="card">
										...
										<div class="card-body">
											...
											<div style="text-align: right; font-size: 18px;">
												<form action="/mypage/mbtiModify.do"
													onsubmit="return check()">
													현재 MBTI:
													<div type="text" id="current_Password">
														<strong>ENTP</strong>
													</div>
													<hr>
													<span id="past">현재 MBTI입니다..</span> <br> 바꿀 MBTI: <input
														type="text" id="newPassWord" name="mbti" required>
													<br> <span class="new">바꿀 MBTI를 입력해주세요. 대문자입력</span> <br>
													<br> MBTI 확인: <input type="text" id="passWordCheck"
														required> <br> <span class="renew">확인을
														위해 한 번 더 입력해주세요.</span> <br> <br> <input
