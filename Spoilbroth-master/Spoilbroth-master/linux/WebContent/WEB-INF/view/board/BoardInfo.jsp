				...
				<div class="container">
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<label style="font-size: 23px; font-family: 'Nanum Gothic', sans-serif; font-weight: 700; margin-top: 18px; margin-bottom: -8px;">
							...
							<div class="emp-profile">
								...
								<div class="d-flex card p-3" style="magin: -11px;">
									<div class="form-group mt-3">
										<label style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 10px;">
											<%=rDTO.getTitle() %></label>
										<div class="card fontstyle p-2" style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;">
											<%=rDTO.getContents() %>
										</div>
									</div>
									
									<hr style="margin-top: 10px; margin-bottom: 0px;" />
										<div class="row" style="font-size: 15px; font-family: 'Nanum Gothic', sans-serif; font-weight: 500; margin-bottom: 0px;">
