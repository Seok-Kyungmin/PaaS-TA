...
<style>
	.fontstyle{
		font-family: 'Nanum Gothic', sans-serif; font-weight: 500; font-size: 15px;
		margin-bottom: 0px;
	}
</style>
</head>
	...
	<div id="colorlib-page">
		...
		<div class="sidebar-heading" style="text-align: center; position: fixed; top: 0; width: 100%; height:130px; background-color: #fff; z-index: 5; padding-top: 20px;font-weight: 500; color: black;">
			...
			<hr style=" width: 90%; height: 1.5px; border: none; background-color: #666666;">
			 <ul class="tagcloud" style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;">
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile">
								<label style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600;">
								...
								<div class="d-flex card m-2 p-3">
									...
									<div>
           								<label style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;">
										분야</label>
