						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile">
								...
								<div class="d-flex card m-2 p-3">
									...
									<hr>
									<div style="font-size: 20px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;">
										...
										<label
											style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600;margin-left: 0; margin-top: 15px; margin-bottom: 10px">
											스터디 분야</label>
										...
										<div class="form-group">
											<textarea id="" cols="20" rows="7" class="form-control"
												name="study_msg"
												style="font-size: 15px;" readonly><%=study_contents%></textarea>
										</div>
