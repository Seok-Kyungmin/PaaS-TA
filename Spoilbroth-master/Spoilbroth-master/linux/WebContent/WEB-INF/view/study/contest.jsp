...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
	...
	<div id="colorlib-page">
		...
		<img alt="" src="/img/DanimgilLogo.png" style="width:100px; display: block; margin: 15px auto;  margin-top: 0px">
			...
			<h4 class="title" style="font-family: 'Poppins', sans-serif; text-align: right; padding-right:25px; font-size: 15px; font-weight: 500;">STUDY INFOMATION</h4>
		 -->
		...
		<div class="sidebar-heading" style="text-align: center; position: fixed; top: 0; width: 100%; height:140px; background-color: #fff; z-index: 5; padding-top: 20px;font-weight: 500; color: black;">
			...
			<ul class="tagcloud" style=" font-family: 'Nanum Gothic', sans-serif; margin-bottom: 0px;">
				<a href="/study/match.do" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ff0050;">이전</a>
				<a href="/study/contest2.do?contest_area=기획아이디어" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">공익/아이디어</a>
				<a href="/study/contest2.do?contest_area=IT/소프트웨어" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">IT/소프트웨어</a>
				<a href="/study/contest2.do?contest_area=디자인" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">패션/디자인</a>
				<a href="/study/contest2.do?contest_area=광고/마케팅" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">광고/마케팅</a>
				<a href="/study/contest2.do?contest_area=문학/시나리오" class="btn btn-outline-warning"
					style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">문학/시나리오</a>
			</ul>
		</div>
		<!-- END 상단 NANI -->
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile">
								<label
									style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600">
									공모전 정보 </label>
								...
								<div class="row" style="font-size: 11px;">
									...
									<!-- 공모전 리스트 반복 -->
									<div class="col-12">
										<table id="example" class="display" style="width: 100%; font-size: 12px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600;">
