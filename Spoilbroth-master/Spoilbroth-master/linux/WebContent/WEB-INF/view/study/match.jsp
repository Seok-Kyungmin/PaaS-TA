...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
	...
	<!-- 	<div class="padding" style="padding-bottom: 20px;"></div>
		...
		<img alt="" src="/img/DanimgilLogo.png" style="width:100px; display: block; margin: 15px auto;  margin-top: 0px">
		 ...
		 -->
		<div class="padding" style="padding-bottom: 140px;"></div>
		<div class="sidebar-heading" style="text-align: center; position: fixed; top: 0; width: 100%; height:140px; background-color: #fff; z-index: 5; padding-top: 20px;font-weight: 500; color: black;">
			...
			<ul class="tagcloud" style="font-family: 'Nanum Gothic', sans-serif; margin-bottom: 0px;">
				<a href="/study/match.do" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;"> 전체</a>
				<a href="/study/match2.do?study_field=IT개발" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;"> IT개발</a>
				<a href="/study/match2.do?study_field=자유스터디" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;"> 자유스터디</a>
				<a href="/study/match2.do?study_field=공모전" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">공모전</a>
				<a href="/study/match2.do?study_field=어학/회화" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">어학/회화</a>
				<a href="/study/match2.do?study_field=봉사활동" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">봉사활동</a>
				<a href="/study/match2.do?study_field=취업/면접" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">취업/면접</a>
				<a href="/study/match2.do?study_field=스포츠" class="btn btn-outline-warning" style="font-size: 12px; border-width: 1.5px; border-color: #ffc107;">스포츠</a>
				<a href="/study/match2.do?study_field=여행" class="btn btn-outline-warning" style="font-style; 'Nanum Gothic', sans-serif;font-size: 12px; border-width: 1.5px; border-color: #ffc107;">여행</a>
			...
			<section class="ftco-section ftco-no-pt ftco-no-pb">
				...
				<div class="row">
					...
					<div class="col-3" OnClick="location.href='/study/contest.do'">
  					<label style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; margin-left: -70px; padding-top: 5px">
							공모전 정보</label>
					</div>
				...
				<!-- 공보전정보, 개설하기 버튼 END -->
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="slider-1">
								<label
									style="margin-top: 8px; font-size: 20px; font-family: 'Nanum Gothic', sans-serif;">
									추천 스터디 </label>
								<div class="owl-carousel owl-theme">
									...
									<!-- 모든 스터디 리스트로 뿌려줌 -->
									<div class="item"
										style="font-size: 28px; font-family: 'Nanum Gothic', sans-serif; coler: white;">
										...
										<div style="margin-top: 10px; margin-bottom: 0px;">
											<label style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif;">
							...
							<hr style="margin-top: 5px; margin-bottom: 0px;" />
							<!-- My 프로필 메인화면 -->
							<label style="margin-top: 8px; font-size: 20px; font-family: 'Nanum Gothic', sans-serif; margin-bottom: 0px;">
								스터디 목록
							</label>
							<hr style="margin-top: 5px; margin-bottom: 0px;" />
							...
							<div class="emp-profile">
								<div class="d-flex">
									...
									<div class="profile-card" style="padding-left: 20px; padding-top: 20px;">
										<h5
											style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 18px; letter-spacing: 8px;">
											<%=pDTO.getStudy_name()%></h5>
										<h6
											style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 18px;">
											<%=pDTO.getStudy_title()%></h6>
										<p class="mb-2" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 18px; color: #6c757d;">
							...
							<div class="emp-profile">
								<div class="d-flex">
									...
									<div class="profile-card col-7">
										<% if(Integer.parseInt(mbti_scores.get(j)) >= 0 && Integer.parseInt(mbti_scores.get(j)) <= 2) {%>
											<span class="mb-2" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px; color: #ff4500;">
											서로 양보하고 노력 해야해요.
											</span>
										<%}else if(Integer.parseInt(mbti_scores.get(j)) >= 3 && Integer.parseInt(mbti_scores.get(j)) <= 4 ){%>
											<span class="mb-2" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px; color: royalblue;">
											이번 기회에 친해져 볼까요?
											</span>
										<%}else{%>
											<span class="mb-2" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px; color: blueviolet;">
											더 없이 좋을수는 없어요. 
											</span>
										<%} %>
									</div>
								...
								<hr style="margin: 5px;">
								<p class="" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px; color: red; margin-bottom:0px">
								※ 스터디그룹에 가입된 팀원의 MBTI를 분석한 결과입니다.
								</p>
							</div>
							<!-- asd -->
							<div class="meta-wrap" style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 20px;">
								<p class="meta">
