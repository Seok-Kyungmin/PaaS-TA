			...
			<div class="wrap-login100" style="padding-top: 50px;">
				...
				<form class="login100-form validate-form" action="/user/loginProc.do" method="post">
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<div>
							<a href="findId" class="txt1">아이디</a> / <a href="findPw" class="txt2">비밀번호 찾기</a>
						</div>
					</div>
					...
					<div class="container-login100-form-btn" style="display: block; padding-top: 10px; margin-right: 25%;">
