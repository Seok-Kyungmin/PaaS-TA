				...
				<div class="row d-flex">
					...
					<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
						...
						<div class="" style="margin-left: 20px">
							<label
								style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 800; margin-top: 18px; margin-bottom: -8px;">
								새 글쓰기
							</label>
						</div>
							...
							<div class="d-flex card p-3" style="magin: -11px;">
								...
								<form name="f" method="post" action="/board/BoardInsert.do" onsubmit="return doSubmit(this);">
									<input type="hidden" name="study_seq" value="<%=CmmUtil.nvl(study_seq)%>" />
										...
										<label style="font-size: 20px; font-family: 'Nanum Gothic', sans-serif; font-weight: 700; margin-left: 5px; margin-top: 5px; margin-bottom: 0px;">
										Title</label>
										<hr style="margin-top: 10px; margin-bottom: 7px;" />
										<div class="card fontstyle p-2" style="font-size: 15px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 8px;width:100%;">
										<input type="text" name="title" maxlength="100" />
										</div>
										
										<label style="font-size: 20px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-top: 18px; margin-bottom: 10px;">
										공지글 여부</label>
											<div style="font-size: 15px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-top: 5px; margin-bottom: 8px;">
												예 <input type="radio" name="notice_yn" value="1"/>
												아니오 <input type="radio" name="notice_yn" value="2"/>
											</div>
										<hr style="margin-top: 10px; margin-bottom: 0px;" />
										<label style="font-size: 20px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-left: 5px; margin-top: 18px; margin-bottom: 0px;">
										CONTENTS</label>
										<div class="card fontstyle p-2" style="font-size: 15px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;width:100%;">
											<textarea name="contents" cols="40" rows="8"></textarea>
										</div>
										<hr style="margin-top: 10px; margin-bottom: 0px;" />
										<div class="row" style="font-size: 13px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; margin-bottom: 0px;">
