					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile">
								<label style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 800;">
								스터디 개설하기
								</label>
								<!-- 사진 프로필 START -->
								<div class="d-flex card m-2 p-3">
										...
										<form action="/study/insertStudyInfo.do" class="p-1 contact-form" method="post" enctype="multipart/form-data" 
											...
											style="font-size: 25px; font-family: 'Nanum Gothic', sans-serif; font-weight: 800;">
										...
										<div>
	              							<label style="font-size: 22px; font-family: 'Nanum Gothic', sans-serif; font-weight: 700; margin-bottom: 10px;">
											스터디 분야
											</label>
								            ...
								            <p class="mb-3" style="font-size: 20px;font-family: 'Nanum Gothic', sans-serif; font-weight: 500;color: #6c757d;float: right;">
