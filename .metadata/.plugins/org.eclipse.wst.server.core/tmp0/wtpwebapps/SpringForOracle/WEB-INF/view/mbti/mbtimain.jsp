				...
				<section class="ftco-section ftco-no-pt ftco-no-pb">
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 py-4 px-md-5" style="background-color: #f7fbff;">
							...
							<hr>
							<div style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 27px;">
							My MBTI</div>
							
							<div class="row p-2">
								<div class="card p-l-55 p-r-55 p-t-65 p-b-54 shadowbox col-6" 
								style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 20px; margin-bottom: 0px;">
								
									<%if(mDTO.getMbti_name()==null){ %>
										<div style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px;">
										아직 측정이 되어있지 않습니다.</div>
									<% }else{ %>
										<div>
										<strong style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 25px;">
							...
							<div class="row p-2">
								...
								style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 15px;">
									...
									<div class="mb-3 mt-2">
										...
										<p style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 17px;">
								...
								<p style="font-family: 'Nanum Gothic', sans-serif; font-weight: 600; font-size: 17px; color:orangered;">
