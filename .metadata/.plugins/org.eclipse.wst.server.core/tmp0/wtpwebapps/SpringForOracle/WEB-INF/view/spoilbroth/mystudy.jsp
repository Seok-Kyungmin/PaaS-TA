...
<body data-aos-easing="slide" data-aos-duration="800" data-aos-delay="0">
	...
	<!-- 전체 페이지 START-->
		...
		<div class="sidebar-heading"
			...
			<hr style="width: 90%; height: 1.5px; border: none; background-color: #666666; margin:4px;" >
		</div>
			<!-- <h4 class="title" style="text-align: right; padding-right:25px; font-size: 15px; font-weight: 300px;">MY STUDY</h4> -->
		<!-- END 상단 NANI -->
	
		<!-- 메인 페이지 START-->
		<div id="colorlib-main" style="margin-top: 70px">
				...
				<div class="container">
					...
					<div class="row d-flex">
						...
						<div class="col-xl-8 px-md-5" style="background-color: #f7fbff;">
							...
							<div class="emp-profile">
								...
								<div class="d-flex">
									...
									<div class="profile-card"
										...
										<h5
											style="font-size: 30px; font-weight: 700; font-family: 'Nanum Gothic', sans-serif; letter-spacing: 8px;">
											<%=user_name%></h5>
										<h6
											style="    font-size: 20px; font-weight: 600;font-family: 'Nanum Gothic', sans-serif;">
											<%=user_dept%></h6>
										<p class="mb-2"
											style="font-size: 19px; font-weight: 600; font-family: 'Nanum Gothic', sans-serif; color: #6c757d;">
								...
								<!-- 사용자 정보 START-->
								<div class="row"
									style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; cursive;">
									<div class="col-md-6">
								...
								<div class="row"
									style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif;font-weight: 600; ">
									<div class="col-md-8">
							...
							<!-- My 프로필 메인화면 -->
							<label
								style="font-size: 25px; font-weight: bold; 'Nanum Gothic', sans-serif; margin-bottom: 0px;">
								가입한 스터디 목록 </label>
							<hr style="margin-top: 5px; margin-bottom: 0px;" />
							...
							<div class="emp-profile">
								<div class="d-flex">
									...
									<div class="profile-card"
										style="padding-left: 20px; padding-top: 20px;">
										<h5
											style="font-size: 26px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; letter-spacing: 8px;">
											<%=pDTO.getStudy_name()%></h5>
										<h6
											style="font-size: 22px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600;">
											<%=pDTO.getStudy_title()%></h6>
										<p class="mb-2"
											style="font-size: 20px;  font-family: 'Nanum Gothic', sans-serif; font-weight: 600; color: #6c757d;">
							...
							<div class="emp-profile">
								<div class="d-flex">
									...
									<div class="profile-card col-7">
										<% if(Integer.parseInt(mbti_scores.get(j)) >= 0 && Integer.parseInt(mbti_scores.get(j)) <= 2) {%>
											<span class="mb-2" style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; color: #ff4500;">
											서로 양보하고 노력 해야해요.
											</span>
										<%}else if(Integer.parseInt(mbti_scores.get(j)) >= 3 && Integer.parseInt(mbti_scores.get(j)) <= 4 ){%>
											<span class="mb-2" style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; color: royalblue;">
											이번 기회에 친해져 볼까요?
											</span>
										<%}else{%>
											<span class="mb-2" style="font-size: 18px; font-family: 'Nanum Gothic', sans-serif; font-weight: 600; color: blueviolet;">
											더 없이 좋을수는 없어요. 
											</span>
										<%} %>
									</div>
								...
								<hr style="margin: 5px;">
								<p class="" style="font-size: 18px; font-weight: 600; font-family: 'Nanum Gothic', sans-serif; color: red; margin-bottom:0px">
							...
							<div class="meta-wrap"
								...
								<p class="mb-4" style="font-size: 18px; font-weight: 600;"><%=pDTO.getStudy_contents() %></p>
							</div>
