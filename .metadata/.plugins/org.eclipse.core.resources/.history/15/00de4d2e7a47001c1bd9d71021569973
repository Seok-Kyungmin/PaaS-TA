						...
						<div class="area_inputs wow fadeIn">
							...
							<form class="login100-form validate-form" method="post" action="/user/findPwAfter.do" onsubmit="return doRegUserCheck(this)">
				                ...
				                <div class="wrap-input100 validate-input m-b-20" data-validate="Useremail is required">
                    				<span class="label-input100">Email</span> 
                    					<input class="input100" type="email" name="user_email" id="user_email" placeholder="Enter useremail">
				                    <span class="focus-input100"></span><button style="">확인</button>
				                </div>
								<div class="container-login100-form-btn" style="display: block; padding-top: 30px; margin-right: 25%;">
									<button class="login100-form-btn" style="margin: auto;" onclick="location.href='/user/findPwAfter.do'">확인</button>
								</div>
								<div class="container-login100-form-btn" style="padding-top: 20px;margin-right: 25%;">
									<button class="login100-form-btn" style="margin: auto; background-color: #565c568c;" onclick="">취소</button>
								</div>
							</form>
							</div>
						</div>
